...
if __name__ == "__main__":
    ...
    sample_images, _ = analysis.select_images(x_train, y_train, num_sample_images_to_show)
    ...
    num_images = 400
    sample_images, sample_labels = analysis.select_images(x_train, y_train, num_images)
    ...
    analysis.plot_images_encoded_in_latent_space(latent_representations, sample_labels)
